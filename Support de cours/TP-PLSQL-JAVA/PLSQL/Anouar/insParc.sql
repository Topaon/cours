...
VALUES ('p2', 'log1', sequenceIns.NEXTVAL, TO_DATE('15/05/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p2', 'log2', sequenceIns.NEXTVAL, TO_DATE('17/09/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p4', 'log5', sequenceIns.NEXTVAL, '', '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p6', 'log6', sequenceIns.NEXTVAL, TO_DATE('20/05/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p6', 'log1', sequenceIns.NEXTVAL, TO_DATE('20/05/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p8', 'log2', sequenceIns.NEXTVAL, TO_DATE('19/05/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p8', 'log6', sequenceIns.NEXTVAL, TO_DATE('20/05/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p11', 'log3', sequenceIns.NEXTVAL, TO_DATE('20/04/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p12', 'log4', sequenceIns.NEXTVAL, TO_DATE('20/04/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p11', 'log7', sequenceIns.NEXTVAL, TO_DATE('20/04/03', 'DD/MM/YY'), '');
INSERT INTO Installer (nPoste, nLog, numIns, dateIns, delai)
VALUES ('p7', 'log7', sequenceIns.NEXTVAL, TO_DATE('01/04/02', 'DD/MM/YY'), '');