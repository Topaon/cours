...
CREATE TABLE visite(
    ...
    CONSTRAINT pk_visite PRIMARY KEY(n_chantier, n_vehicule, kilometres),
...
CREATE TABLE transporter(
    transporter VARCHAR2(4),
    CONSTRAINT pk_transporter PRIMARY KEY(n_chantier, n_vehicule, kilometres) REFERENCES chantier(n_chantier), vehicule(n_vehicule), employe(n_emp);
