...
public class SimpleDataSource {
	...
	/**
	 * Permet d'initialiser les paramètres de connexion à la BDD depuis le fichier
	 * de proprietes
	 * 
	...
	/**
	 * Permet d'etablir une connection à la BDD à partir des paramètres de connexion
	 * 
